...
def extract_urls_from_page(base_url):
    """Extract only same-domain URLs from a page"""
    urls = []
    try:
        headers = {
        ...
        for link in soup.find_all('a'):
            ...
            if href:
                ...
                if is_valid_url(absolute_url) and get_domain(absolute_url) == base_domain:
...
def main():
    parser = argparse.ArgumentParser(description='Advanced URL Extractor Tool (Same-Domain Only)', 
